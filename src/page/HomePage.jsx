...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    const dummyProducts = [
      ...
      {
        id: 2,
        title: "Golden Pearl Earrings",
        price: 1599.99,
        image:
          "https://images.pexels.com/photos/618701/pexels-photo-618701.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
        rating: 4.8,
        tags: ["popular"],
      },
      {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  name: "Everyday",
                  image:
                    "https://images.unsplash.com/photo-1600721391689-2564bb8055de?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
                },
                {
                  name: "Luxury",
                  image:
